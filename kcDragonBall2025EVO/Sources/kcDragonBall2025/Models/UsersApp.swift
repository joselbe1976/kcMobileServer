...
final class UsersApp : Model, Content, @unchecked Sendable{
    static let schema = "users"

    @ID()
    var id : UUID? // Identificador
...
extension  UsersApp : ModelAuthenticatable, ModelCredentialsAuthenticatable{
    ...
    static var usernameKey: KeyPath<UsersApp, Field<String>> {
        \UsersApp.$email
    }
    
    static var passwordHashKey: KeyPath<UsersApp, Field<String>> {
        \UsersApp.$password
    }
    
    
    // Security: Basic Auythetication
   // static let usernameKey = \UsersApp.$email
   // static let passwordHashKey = \UsersApp.$password
